...
namespace util
{
    // a class that manages sfml's resources to make sure we don't load textures/ fonts twice
    // all these just throw errors, if you want you can catch them, but I don't.
    class SfManager
    {
    public:
