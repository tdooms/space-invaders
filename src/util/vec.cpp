...
Vec2d &Vec2d::normalize() noexcept { return *this /= length(); }
Vec2d Vec2d::normalized() const noexcept { return *this / length(); }
double Vec2d::length() const noexcept { return std::sqrt(x * x + y * y); }
...
Vec2d operator*(Vec2d lhs, double scalar) noexcept { return lhs *= scalar; }
Vec2d operator*(double scalar, Vec2d rhs) noexcept { return rhs *= scalar; }
Vec2d operator/(Vec2d lhs, double scalar) noexcept { return lhs /= scalar; }
Vec2d operator/(double scalar, Vec2d rhs) noexcept { return rhs /= scalar; }
...
double dist(Vec2d lhs, Vec2d rhs) noexcept { return (rhs - lhs).length(); }
